...
{
    int spot, echo;
    bufferLength += sprintf(buffer + bufferLength, "#x_m,#y_m,#z_m,#range_m,#vertical_rad,#horizontal_rad,#intensity,#spot(0-%d),#echo(0-max%d),#->frame:motor_field:line->,%d,%d,%d\n", sensorInfo.spec.spotCount - 1, sensorInfo.spec.echoCount - 1, mData.frameNumber, mData.motorFieldNumber, mData.lineNumber);
